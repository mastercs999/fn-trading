...
{
    [Serializable]
    public class GruLayer : DropoutLayer, ILayer
    {
        int _inputDimension;
        ...
        public GruLayer(int inputDimension, int outputDimension, double initParamsStdDev, Random rng, double dropout) : base(dropout, inputDimension, outputDimension, rng)
        {
